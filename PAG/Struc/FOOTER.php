             ...
             <hr style="background-color: #fff">
              <div class="row" style="margin-top: 20px;">
                <div class="col-md-2 col-sm-12 col-xs-12">
                  <img src="/Nutri_TCC/Img/Aiko.jpg" class="img-nutri2">
                </div>
              ...
              <div class="row" style="margin-top: 20px;">
                <div class="col-md-2 col-sm-12 col-xs-12">
                  <img src="/Nutri_TCC/Img/claudia-lobo.jpg" class="img-nutri2">
                </div>
                <div class="col-md-10 col-sm-12 col-xs-12">
              ...
              <div class="row" style="margin-top: 20px;">
                <div class="col-md-2 col-sm-12 col-xs-12">
                  <img src="/Nutri_TCC/Img/paloma.jpg" class="img-nutri2">
                </div>
                <div class="col-md-10 col-sm-12 col-xs-12">
